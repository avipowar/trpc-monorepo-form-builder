...
export default function SignupPage() {
  ...
  // The clean unified data object from react-hook-form goes straight to tRPC
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                {...register("fullName", { required: "Full name is required, भाऊ!" })}
